...
def Search(request):
    ...
    if form.is_valid():
            ...
            df = pd.read_excel('C:\\Users\\Anton\\Desktop\\python\\geochemistry.xlsx')
            df2 = pd.read_excel('C:\\Users\\Anton\\Desktop\\python\\faced.xlsx')
    ...
    return render(request, "insert_article/search.html",
                  context={'form': form, 'df':df, 'df2':df2, 'submitbutton':submitbutton})
